...
DP :: DP () : maxC_value(100), maxA_value(300), discrete_reader(0.5), discrete(0.5), smallNum(0.0001), c_mean(0.0), c_std(5.0), discR(1.0/1.02), action_step_size(0.5), returnRate(0.05){
