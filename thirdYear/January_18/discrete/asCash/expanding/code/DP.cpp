...
DP :: DP (double dis1, double dis2) : maxC_value(100), maxA_value(300), discrete_reader(dis1), discrete(dis2), smallNum(0.0001), c_mean(0.0), c_std(5.0), discR(1.0/1.02), action_step_size(0.5), returnRate(0.05){
